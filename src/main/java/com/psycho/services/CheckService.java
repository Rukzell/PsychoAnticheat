...
import com.psycho.checks.impl.combat.killaura.KillAuraWallHit;
...
public class CheckService {
    ...
    private void registerFactories() {
        ...
        registerFactory(p -> new AimSignal(p, "checks.aimassist.signal", cfg.loadCheck("checks.aimassist.signal", 10)));
        ...
        registerFactory(p -> new KillAuraWallHit(p, "checks.killaura.wallhit", cfg.loadCheck("checks.killaura.wallhit", 10)));
