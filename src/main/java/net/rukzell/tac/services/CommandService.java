...
import net.rukzell.tac.commands.ReloadCommand;
import net.rukzell.tac.commands.SubCommand;
...
public class CommandService implements CommandExecutor, TabCompleter {
    ...
    public CommandService(TornadoAC plugin) {
        this.plugin = plugin;
        registerSubCommands();
    }
